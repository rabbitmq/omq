...
func RootCmd() *cobra.Command {
	...
	rootCmd.PersistentFlags().StringVarP(&cfg.PublishTo, "publish-to", "q", "/topic/omq", "The topic/terminus to publish to (%d will be replaced with the publisher's id)")
	rootCmd.PersistentFlags().StringVarP(&cfg.ConsumeFrom, "consume-from", "Q", "/topic/omq", "The queue/topic/terminus to consume from (%d will be replaced with the consumer's id)")
